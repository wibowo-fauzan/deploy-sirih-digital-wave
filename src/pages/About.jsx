        ...
        <div class="col-lg-6">
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="info">
                <div class="icon icon-shape text-center">
                  <svg class="text-info mb-5" width="25px" height="25px" viewBox="0 0 40 40" version="1.1"
            ...
            <div class="col-md-6">
              <div class="info">
                <div class="icon icon-shape text-center">
                  <svg class="text-info mb-5" width="43px" height="20px" viewBox="0 0 43 36" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="info">
                <div class="icon icon-shape text-center">
                  <svg class="text-info mb-5" width="25px" height="25px" viewBox="0 0 42 42" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-md-6">
              <div class="info">
                <div class="icon icon-shape text-center">
                  <svg class="text-info mb-5" width="25px" height="25px" viewBox="0 0 46 42" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
