                        ...
                        <div className="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
                            <ul className="navbar-nav navbar-nav-hover w-100">
                                <li className="nav-item dropdown dropdown-hover mx-2">
                                    <a className="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" href="javascript:;" id="dropdownMenuDocs" data-bs-toggle="dropdown" aria-expanded="false"> Pages  
                                        <Icondownarrow />
                                    </a>
                                ...
                                <li className="nav-item ms-auto d-flex align-items-center justify-content-center gap-4 text-center">
                                    ...
                                    <a className="btn btn-sm btn-round mb-0 me-5 mt-2 mt-md-0">Example Template</a>
                                </li>
                            </ul>
                        </div>
                    </div>
