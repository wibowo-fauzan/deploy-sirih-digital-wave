        ...
        <div className="container">
            <div className="row">
                <div className="col-md-1">
                    ...
                    <h2 className="text-center bg-light text-dark">PREMIUM</h2>
            </div>
                        ...
                        <div className="row no-gutters">
                                    ...
                                    <div className="row">
                                        <div className="ps-0">
                                            ...
                                            <div className="info d-flex align-items-center p-2">
                                                ...
                                                <div>
                                                    <span className="ps-2">REQUEST HALAMAN BLOGGER</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="col-lg-4 my-auto">
                                <div className="card-body text-center">
                                    ...
                                    <h1 className="mt-0">
                                        <small>Rp.</small>2.000.000
                                    </h1>
                                    <a href="https://wa.me/6283157346828?text=*PREMIUM*%0A%0A-%20DOMAIN%20WEBSITE%20%2F%20TAHUN%0A-%20HOSTING%20WEBSITE%20%2F%20BULAN%0AWEBSITE%20PEMBANGUNAN%20SATU%20BULAN%0A-%20REQUEST%20HALAMAN%20LANDING%20SATU%20HALAMAN%0A-%20RESPONSIVE%20WEBSITE%0A-%20SOCIAL%20MEDIA%20LINK%0A-%20REQUEST%20HALAMAN%20BLOGGER%0A%0A*SAYA%20MINTA%20SAMPLE%20WEBSITE*" type="button" className="btn bg-gradient-info btn-lg mt-4"> Get Access </a>
