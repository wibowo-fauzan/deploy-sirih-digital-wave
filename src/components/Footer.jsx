...
<div className="position-relative mt-5 pt-5">
                ...
                <div className="row">
                    <div className="col-md-8 mx-auto text-center">
                        <div className="text-center mx-auto">
                            <h3 className="text-white">Jadilah orang pertama yang menghubungi</h3>
                            <p className="text-white"> Perusahaan Anda mungkin bukan bisnis
                                perangkat lunak, tetapi perangkat lunak akan mendukung bisnis Anda dengan membangun
                                website, profil perusahaan, dan e-commerce. </p>
                        </div>
                        <div className="row">
                            <div className="col-sm-5 ms-auto">
                                <div className="input-group">
                                    <input type="text" className="form-control mb-sm-0 mb-2"
                                        placeholder="Email Here..." />
                                </div>
                            </div>
                            <div className="col-sm-3 me-auto text-start">
                                <button type="button"
                                    className="btn bg-white w-100 mb-0 h-100 position-relative z-index-2">
                                    Subscribe
                                </button>
                            </div>
                        </div>
    ...
    <footer className="footer pb-5 pt-10 bg-light mt-n8 position-relative">
        ...
        <div className="container">
            <div className="row">
                <div className="col-lg-3 d-flex justify-content-center align-items-center space2-responsive-footer">
