    ...
    <section className="py-lg-5 bg-light space-responsive-basicplan">
        <div className="container">
            <div className="row">
                ...
                <h2 className="text-center bg-light text-dark">HOT OFFER</h2>
            </div>
                                    ...
                                    <div className="row">
                                        <div className="ps-0">
                                            ...
                                            <div className="info d-flex align-items-center p-2">
                                                ...
                                                <div>
                                                    <span className="ps-2">REQUEST PAGE BLOGGER / E - COMMERCE</span>
                                                </div>
                                            </div>
                                            <div className="info d-flex align-items-center p-2">
                                                <div
                                                ...
                                                <div>
                                                    <span className="ps-2">REQUEST ROLE ACCOUNT</span>
                                                </div>
                                            </div>
                                            <div className="info d-flex align-items-center p-2">
                                                <div
                                                ...
                                                <div>
                                                    <span className="ps-2">REQUEST API</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
